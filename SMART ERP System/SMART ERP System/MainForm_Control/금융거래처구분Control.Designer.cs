namespace SMART_ERP_System.MainForm_Control
{
    partial class 금융거래처구분Control
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.계좌번호DataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.사업자등록번호DataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.금융거래처등록BindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.금융거래처등록BindingSource)).BeginInit();
            this.SuspendLayout();
            // 
            // splitContainer
            // 
            ...
            this.계좌번호DataGridViewTextBoxColumn,
            this.사업자등록번호DataGridViewTextBoxColumn});
            this.dgv거래처List.DataSource = this.금융거래처등록BindingSource;
            ...
            // 
            this.금융거래처코드DataGridViewTextBoxColumn.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.None;
            this.금융거래처코드DataGridViewTextBoxColumn.DataPropertyName = "금융거래처코드";
            this.금융거래처코드DataGridViewTextBoxColumn.HeaderText = "거래처코드";
            this.금융거래처코드DataGridViewTextBoxColumn.Name = "금융거래처코드DataGridViewTextBoxColumn";
            this.금융거래처코드DataGridViewTextBoxColumn.ReadOnly = true;
            this.금융거래처코드DataGridViewTextBoxColumn.Width = 95;
            // 
            // 금융거래처명DataGridViewTextBoxColumn
            // 
            this.금융거래처명DataGridViewTextBoxColumn.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.None;
            this.금융거래처명DataGridViewTextBoxColumn.DataPropertyName = "금융거래처명";
            this.금융거래처명DataGridViewTextBoxColumn.HeaderText = "거래처명";
            this.금융거래처명DataGridViewTextBoxColumn.Name = "금융거래처명DataGridViewTextBoxColumn";
            this.금융거래처명DataGridViewTextBoxColumn.ReadOnly = true;
            this.금융거래처명DataGridViewTextBoxColumn.Width = 90;
            // 
            // 계좌번호DataGridViewTextBoxColumn
            // 
            this.계좌번호DataGridViewTextBoxColumn.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.None;
            this.계좌번호DataGridViewTextBoxColumn.DataPropertyName = "계좌번호";
            this.계좌번호DataGridViewTextBoxColumn.HeaderText = "계좌번호";
            this.계좌번호DataGridViewTextBoxColumn.Name = "계좌번호DataGridViewTextBoxColumn";
            this.계좌번호DataGridViewTextBoxColumn.ReadOnly = true;
            this.계좌번호DataGridViewTextBoxColumn.Width = 120;
            // 
            // 사업자등록번호DataGridViewTextBoxColumn
            // 
            this.사업자등록번호DataGridViewTextBoxColumn.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
            ...
            // 
            // 금융거래처등록BindingSource
            // 
            this.금융거래처등록BindingSource.DataSource = typeof(ClassLibrary.금융거래처등록);
            // 
            // 금융거래처구분Control
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.금융거래처등록BindingSource)).EndInit();
